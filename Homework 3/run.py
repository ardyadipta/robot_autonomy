...
def main(robot, planning_env, planner):
    ...
    print "Execution time:" , time.clock() - now
    #print plan
...
if __name__ == "__main__":
    ...
    if args.planner == 'astar':
        planner = AStarPlanner(planning_env, visualize=visualize)
    elif args.planner == 'bfs':
        planner = BreadthFirstPlanner(planning_env, visualize=visualize)
    elif args.planner == 'dfs':
        planner = DepthFirstPlanner(planning_env, visualize=visualize)
    elif args.planner == 'hrrt':
        planner = HeuristicRRTPlanner(planning_env, visualize=visualize)
    else:
